...
public class MapManager : MonoBehaviour {
    ...
    public void GenerateMapDataTexture(Vector2 center, int lod, int chunkSize, RenderTexture mapData) {
        ...
        densityGenerator.GenerateMapDensityTexture(mapData, chunkSize, gridScale, lod, biomeDensityData, center3d, null, new Vector2(), DensityNoiseTextureShader);
    }
    ...
    public void GenerateMapDataTextureFrom3DOrigin(Vector3 center, int lod, int chunkSize, RenderTexture mapData) {
        DensityGenerator densityGenerator = new DensityGenerator();
        densityGenerator.GenerateMapDensityTexture(mapData, chunkSize, gridScale, lod, biomeDensityData, center, null, new Vector2(), DensityNoiseTextureShader);
    }
}
