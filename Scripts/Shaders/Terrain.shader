    ...
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            for(int i = 0; i < layerCount; i++) {
                ...
                float3 texturColor = triplanar(IN.worldPos, baseTextureScales[i], blendAxes, i) * (1 - baseColorStrength[i]);

                o.Albedo = o.Albedo * (1-drawStrength) + (baseColor + texturColor) * drawStrength;
            }
