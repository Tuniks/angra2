...
Shader "Custom Shader/NewChunkGeometry"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings LitPassVertex(uint vertexID: SV_VertexID) {
                ...
                input.positionOS = float4(vertPos.x, vertPos.y, vertPos.z, 1);
                input.normalOS = float3(1,1,1);
                input.uv = float2(vertPos.x/205, vertPos.z/205);
                input.uvLM = float2(vertPos.x/205, vertPos.z/205);
